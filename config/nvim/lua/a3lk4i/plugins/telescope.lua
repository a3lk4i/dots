...
return {
  ...
  keys = {
    ...
    { "<leader><space>", telescope("git_files"), desc = "Find Files (git)" },
    -- find
    { "<leader>fb", "<cmd>Telescope buffers<cr>", desc = "Buffers" },
    { "<leader>ff", telescope("git_files"), desc = "Find Files (git)" },
    { "<leader>fF", telescope("find_files", { cwd = false }), desc = "Find Files (cwd)" },
