...
require("lazy").setup({
    ...
    --
    -- Base plugins in increasing order of complexity. See comments within each of the files.
    ...
    -- LSP Configuration & dependencies
    ...
    -- Collection of various plugins/modules like statusline, around/inside, sorround etc..
